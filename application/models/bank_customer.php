...
class Bank extends Entity
{
    ...
    function insert()
    {
        ...
        $str = "INSERT INTO BANK 
                (BANK_ID, NAMA, KODE_REKENING, NAMA_REKENING, CREATED_BY, CREATED_DATE)
                VALUES (
    ...
    {
        $str = "SELECT A.BANK_ID,A.NAMA,A.KODE_REKENING, A.NAMA_REKENING, A.CREATED_BY,A.CREATED_DATE,A.UPDATED_BY,A.UPDATED_DATE
                FROM BANK A
        WHERE 1=1 ";
