  ...
  class Entitas extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$this->setField("ENTITAS_ID", $this->getSeqId("ENTITAS_ID","ENTITAS"));  
		$str = "
				INSERT INTO ENTITAS(
            ENTITAS_ID, KODE, NAMA, KETERANGAN, ALAMAT, LOKASI, TELEPON, 
            FAXIMILE, EMAIL, STATUS_ENTITAS)
    ...
    VALUES (
					  ...
					  '".$this->getField("EMAIL")."',
					  '".$this->getField("STATUS_ENTITAS")."'

				)"; 
		$this->id = $this->getField("ENTITAS_ID");
    ...
    function update()
	{
		...
		$str = "
			   ...
			   WHERE ENTITAS_ID = '".$this->getField("ENTITAS_ID")."';
 				"; 
				//echo $str;
				$this->query = $str;
		return $this->execQuery($str);
	...
	function delete()
	{
        $str = "DELETE FROM ENTITAS
                WHERE 
				  ENTITAS_ID= '".$this->getField("ENTITAS_ID")."'
				  "; 
    ...
    **/ 
	...
	{
		$str = "SELECT ENTITAS_ID, KODE, NAMA, KETERANGAN, ALAMAT, LOKASI, TELEPON, 
