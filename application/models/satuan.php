...
class Satuan  extends Entity
{
	...
	function insert()
	{
		$this->setField("SATUAN_ID", $this->getSeqId("SATUAN_ID", "SATUAN"));
	...
	{
		$str = "SELECT A.SATUAN_ID,A.NAME,A.DESCRIPTION,A.CREATED_BY,A.CREATED_DATE,A.UPDATED_BY,A.UPDATED_DATE
				FROM SATUAN A
				WHERE 1=1 ";
