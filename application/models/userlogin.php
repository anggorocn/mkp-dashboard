...
class UserLogin extends Entity
{
	...
	function insert()
	{
		...
		$this->setField("USER_LOGIN_ID", $this->getSeqId("USER_LOGIN_ID", "USER_LOGIN"));
		...
		$str = "
				...
				VALUES ( '" . $this->getField("USER_LOGIN_ID") . "', '" . (int)$this->getField("USER_GROUP_ID") . "', '" . $this->getField("PEGAWAI_ID") . "',
					...
					'" . $this->getField("USER_PASS") . "', '" . $this->getField("LAST_CREATE_USER") . "', CURRENT_DATE )
				";
