  ...
  class UserGroup extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$this->setField("USER_GROUP_ID", $this->getSeqId("USER_GROUP_ID","USER_GROUP"));
		...
		$str = "
				...
				VALUES ( '".$this->getField("USER_GROUP_ID")."', '".$this->getField("NAMA")."', '".$this->getField("KETERANGAN")."',
					...
					'".$this->getField("AKSES_PROSES_REKAP")."', '".$this->getField("LAST_CREATE_USER")."', ".$this->getField("LAST_CREATE_DATE").")
				"; 
