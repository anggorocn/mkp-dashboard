...
class Email extends Entity
{
    ...
    function insert()
    {
        ...
        $this->setField("EMAIL_ID", $this->getSeqId("EMAIL_ID", "EMAIL"));

        $str = "INSERT INTO EMAIL(
        ...
        $this->id = $this->getField("EMAIL_ID");
        $this->query = $str;
        // echo $str;
        // exit;
    ...
    function selectByParams($paramsArray = array(), $limit = -1, $from = -1, $statement = "", $order = "ORDER BY A.EMAIL_ID ASC")
    {
        $str = "SELECT  
                  A.EMAIL_ID, A.SUBJECT, A.BODY
                FROM EMAIL A
                WHERE 1=1
				";
    ...
    {
        $str = "SELECT COUNT(EMAIL_ID) AS ROWCOUNT FROM EMAIL A
