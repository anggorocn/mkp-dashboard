...
class Certificate extends Entity
{
    ...
    function insert()
    {
        ...
        $this->setField("CERTIFICATE_ID", $this->getSeqId("CERTIFICATE_ID", "CERTIFICATE"));

        $str = "INSERT INTO CERTIFICATE(
    ...
    function selectByParams($paramsArray = array(), $limit = -1, $from = -1, $statement = "", $order = "ORDER BY CERTIFICATE_ID ASC")
    {
        $str = "SELECT  
                    A.CERTIFICATE_ID, A.CERTIFICATE, A.DESCRIPTION
                FROM CERTIFICATE A
                WHERE 1=1
				";
    ...
    {
        $str = "SELECT COUNT(CERTIFICATE_ID) AS ROWCOUNT FROM CERTIFICATE A
