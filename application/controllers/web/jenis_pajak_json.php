...
class jenis_pajak_json extends CI_Controller
{
    ...
    function add()
    {
        ...
        if ($reqMode == "insert") {
            $jenis_pajak->setField('KD_BUKU_BESAR', $reqKdBukuBesar);
            $jenis_pajak->setField('NAMA', $reqNama);
            $jenis_pajak->setField('KETERANGAN', $reqKeterangan);
            $jenis_pajak->setField("CREATED_BY", $this->nama);
            $jenis_pajak->setField("CREATED_DATE", "CURRENT_DATE");
            if ($jenis_pajak->insert())
                echo "Data berhasil disimpan.";
        } else {
            $jenis_pajak->setField('JENIS_PAJAK_ID', $reqId);
            $jenis_pajak->setField('KD_BUKU_BESAR', $reqKdBukuBesar);
            $jenis_pajak->setField('NAMA', $reqNama);
            $jenis_pajak->setField('KETERANGAN', $reqKeterangan);
            $jenis_pajak->setField("UPDATED_BY", $this->nama);
            $jenis_pajak->setField("UPDATED_DATE", "CURRENT_DATE");
            if ($jenis_pajak->update())
                echo "Data berhasil disimpan.";
        }
    }
    ...
    function delete()
    {
        ...
        $this->load->model("JenisPajak");
        $jenis_dokumen = new JenisPajak();

        $jenis_dokumen->setField("JENIS_PAJAK_ID", $reqId);
        if ($jenis_dokumen->delete())
