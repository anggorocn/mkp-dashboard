...
class invoice_detail_json extends CI_Controller
{
    ...
    function json()
    {
        ...
        $aColumns = array("INVOICE_DETAIL_ID", "INVOICE_ID", "SERVICE_TYPE", "SERVICE_DATE", "LOCATION", "VESSEL", "AMOUNT_IDR", "AMOUNT_USD", "AMOUNT", "CURRENCY", "AKSI", "ADDITIONAL");

        $aColumnsAlias = array("INVOICE_DETAIL_ID", "INVOICE_ID", "SERVICE_TYPE", "SERVICE_DATE", "LOCATION", "VESSEL", "AMOUNT_IDR", "AMOUNT_USD", "AMOUNT", "CURRENCY", "AKSI", "ADDITIONAL");
        ...
        $invoice_detail->selectByParamsMonitoring(array(), $dsplyRange, $dsplyStart, $statement_privacy . $statement, $sOrder);
