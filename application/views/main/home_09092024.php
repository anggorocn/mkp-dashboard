...
$TREN_KPI_REALISASI=[91.69, 97.05, 99.31, 102.11, 106.25, 103.74, 105.27];
$TREN_KPI_PROGNOSA=[0, 0, 97.55, 49.43, 81.12, 81.12, 93.03, 94.12, 93.63, 95.78, 96.24, 101.22];

$KPI_TIDAK_TERCAPAI[0]=[ "nama" => "BOPO", "realisasi" => "92,77","target" => "92,62","kemarin" => '93,59'];

$TOTAL_PEGAWAI=[ 4503,   4532,    4552,    4684,    4730,    4778,    4797,    0];
$TOTAL_PEGAWAI_PKWT=[2225,   2271,    2267,    2265,    2259,    2251,    2239];
$TOTAL_PEGAWAI_PKWTT=[2278, 2261,    2285,    2419,    2471,    2527,    2558];
                                                    ...
                                                    <div class="inner">
                                                        ...
                                                        <div class="area-jumlah-angka">
                                                            <div class="item">
                                                                ...
                                                                <strong><?=$TOTAL_PEGAWAI[$reqBulan]?></strong> orang
                                                            </div>
                                                            <div class="item">
                                                                <i class="fa fa-user" aria-hidden="true"></i>
                                                                <strong>57</strong> unit
                                                            </div>
                                                            <div class="item">
                                                                <i class="fa fa-user" aria-hidden="true"></i>
                                                                <strong><?=($PROJECT_ON_GOING+$PROJECT_DONE+$PROJECT_UPCOMING)?></strong> proyek
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body border-left-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 padding-left-none">
                                                ...
                                                <div class="item-data-angka">
                                                    <div class="title">YoY</div>
                                                    <div class="nilai">Rp<?=$PENDAPATAN_REALISASI[$reqBulan]?>7 M</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <? for($i=0;$i<count($KPI_TIDAK_TERCAPAI);$i++){ ?>
                                                <div>
                                                    <div class="card">
                                                        ...
                                                        <!-- Card Body -->
                                                        <div class="card-body">
                                                            <div class="nilai"><span><?=$KPI_TIDAK_TERCAPAI[$i]['realisasi']?> %</span>  Current Month</div>
                                                            <div class="nilai"><span><?=$KPI_TIDAK_TERCAPAI[$i]['kemarin']?> %</span>       Last Month</div>
                                                            <div class="nilai"><span><?=$KPI_TIDAK_TERCAPAI[$i]['target']?> %</span>  Target this month</div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="area-total-employee">
                                        <!-- <div class="nilai" style="font-size:30px"><?=$TOTAL_PEGAWAI[$reqBulan]?></div> -->
                                        <div class="nilai" style="font-size: 27px">4797</div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="item">
                                                    ...
                                                    <div class="nilai"><?=$kontak_Sign?></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="item">
                                                    <div class="title">Unsign</div>
                                                    <div class="nilai"><?=$kontrak_Unsign?></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="item">
                                                    <div class="title">3 Month Left</div>
                                                    <div class="nilai"><?=$kontrak_resign?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            // },
             {
                ...
                name: 'PROGNOSA',
                data: <?=json_encode($TREN_KPI_PROGNOSA)?>
            }],
            // }, {
    ...
    <script type="text/javascript">
        Highcharts.chart('grafik-trend-pendapatan', {
            ...
            series: [
                ...
                {
                  name: 'PROGNOSA',
                    data: <?=json_encode($PENDAPATAN_PROGNOSA)?>,
                  color: "green"
                }
              ],
            legend: {
