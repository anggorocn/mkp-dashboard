...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = $('#example').dataTable({
                ...
                "ordering": true,
                "searching": true,
                "ajax":"tes_json/json_status_bawahan",
                "columns":[
                    {data: "jabatan"},
                    {data: "sub_unit"},
                    {data: "status_bawahan"},
...
<div class="row">
            ...
            <ul>
                ...
                <li><a data-toggle="collapse" data-target="#collapse2">Manajemen Data</a>
                    <ul id="collapse2" class="collapse in">
                        ...
                        <li class="active"><a href="app/index/kelola_status_bawahan">Satatus Bawahan</a></li>
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Kelola Status Bawwahan</div>
            </div>
