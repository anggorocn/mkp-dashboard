...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = $('#example').dataTable({
                ...
                "ordering": true,
                "searching": true,
                "ajax":"tes_json/json_jabatan_karyawan",
                "columns":[
                    {data: "perusahaan"},
                    {data: "nik"},
                    {data: "nama"},
...
<div class="row">
            ...
            <ul>
                ...
                <li><a data-toggle="collapse" data-target="#collapse2">Manajemen Data</a>
                    <ul id="collapse2" class="collapse in">
                        ...
                        <li class="active"><a href="app/index/kelola_jabatan_karyawan">Jabatan Karyawan</a></li>
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Kelola Jabatan Karyawan</div>
            </div>
