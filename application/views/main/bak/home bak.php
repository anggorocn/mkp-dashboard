<div class="row">
    <div class="col-md-12">
        <div class="area-home">
            <div class="area-status-pengaduan">
                <h4 class="title">Status Pengaduan</h4>
                <div class="inner">
                    <div class="item">
                        <div class="nilai">4</div>
                        <div class="keterangan">Open</div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="item">
                        <div class="nilai">2</div>
                        <div class="keterangan">Progress</div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="item">
                        <div class="nilai">5</div>
                        <div class="keterangan">Close</div>
                        <div class="clearfix"></div>
                    </div>
                </div>
            </div>
...
<div class="jumbotron">
    ...
    <p>
        <a class="btn btn-lg btn-primary" href="lib/bootstrap-3.3.7/docs/components/#navbar" role="button">View navbar docs &raquo;</a>
    </p>
</div>
-->
