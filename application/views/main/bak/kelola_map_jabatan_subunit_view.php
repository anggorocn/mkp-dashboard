<?
    $sub_unit = $this->input->get('reqSubUnit');
?>
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = $('#example').dataTable({
                ...
                "ordering": true,
                "searching": true,
                "ajax":"tes_json/json_jabatan_sub_unit",
                "columns":[
                    {data: "kode"},
                    {data: "nama"},
                    {data: "level"},
                    {
                        data: null,
                        className: "",
                        defaultContent: '<button class="aksi-delete"><i class="fa fa-trash"></i></button>'
                    },
                ]
            });

            $('#btnAdd').on( 'click', function () {
                top.openAdd("app/index/popup_jabatan");
            } );
    });
...
<div class="row">
            ...
            <ul>
                ...
                <li><a data-toggle="collapse" data-target="#collapse2">Manajemen Data</a>
                    <ul id="collapse2" class="collapse in">
                        <li class="active"><a href="app/index/kelola_map_jabatan_subunit">Mapping Jabatan - Sub Unit</a></li>
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Data Jabatan pada Sub Unit <?=$sub_unit?></div>
            </div>

            <div class="col-md-12">

                <div class="area-menu-aksi">
                    <a class="btn btn-primary btn-xs" id="btnAdd"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Jabatan</a>
