    ...
    $(document).ready(function() {
        ...
        var oTable = $('#example').dataTable({
            ...
            $('#example tbody').on( 'click', '.aksi-edit', function () {
                ...
                document.getElementById("kode-unit").value = data.kode;
                document.getElementById("nama-unit").value = data.nama;
                document.getElementById("alias-unit").value = data.alias;
            } );
            ...
            {
                $('#exampleModalCenter').modal('show');
                document.getElementById("kode-sub-unit").value = "";
                document.getElementById("nama-sub-unit").value = "";
...
<div class="row">
            ...
            <ul>
                ...
                <li class="menu"><a data-toggle="collapse" data-target="#collapse1">Master Data</a>
                    <ul id="collapse1" class="collapse in">
                        ...
                        <li class="active"><a href="app/index/kelola_unit">Unit</a></li>
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Kelola Unit</div>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color: rgba(0, 0, 0, 0.1);">
          <div class="form-group">
            <label for="kode-unit" class="col-form-label">Kode :</label>
            <input type="text" class="form-control" id="kode-unit" name="kode-unit">
          </div>
          <div class="form-group">
            <label for="nama-unit" class="col-form-label">Nama Unit :</label>
            <textarea class="form-control" id="nama-unit"></textarea>
          </div>
          <div class="form-group">
            <label for="alias-unit" class="col-form-label">Alias :</label>
            <input type="text" class="form-control" id="alias-unit" name="alias-unit">
          </div>
      </div>
