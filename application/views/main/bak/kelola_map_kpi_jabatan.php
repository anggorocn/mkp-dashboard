...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = $('#example').dataTable({
                ...
                "ordering": true,
                "searching": true,
                "ajax":"tes_json/json_map_kpi_jab",
                "columns":[
                    {data: "jabatan"},
                    {data: "jumlah"},
                    {
...
<div class="row">
            ...
            <ul>
                ...
                <li><a data-toggle="collapse" data-target="#collapse2">Manajemen Data</a>
                    <ul id="collapse2" class="collapse in">
                        ...
                        <li class="active"><a href="app/index/kelola_map_kpi_jabatan">Mapping KPI - Jabatan</a></li>
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Mapping KPI ke Jabatan</div>
            </div>
