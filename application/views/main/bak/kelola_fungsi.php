    ...
    $(document).ready(function() {
        ...
        var oTable = $('#example').dataTable({
            ...
            $('#example tbody').on( 'click', '.aksi-edit', function () {
                ...
                document.getElementById("kode-fungsi").value = data.kode;
                document.getElementById("nama-fungsi").value = data.nama;
                document.getElementById("alias-fungsi").value = data.alias;
            } );
            ...
            {
                $('#exampleModalCenter').modal('show');
                document.getElementById("kode-fungsi").value = "";
                document.getElementById("nama-fungsi").value = "";
                document.getElementById("alias-fungsi").value = "";
            });
...
<div class="row">
            ...
            <ul>
                ...
                <li class="menu"><a data-toggle="collapse" data-target="#collapse1">Master Data</a>
                    <ul id="collapse1" class="collapse in">
                        ...
                        <li class="active"><a href="app/index/kelola_fungsi">Fungsi</a></li>
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Kelola Fungsi</div>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color: rgba(0, 0, 0, 0.1);">
          <div class="form-group">
            <label for="kode-fungsi" class="col-form-label">Kode :</label>
            <input type="text" class="form-control" id="kode-fungsi" name="kode-fungsi">
          </div>
          <div class="form-group">
            <label for="nama-fungsi" class="col-form-label">Nama :</label>
            <textarea class="form-control" id="nama-fungsi"></textarea>
          </div>
          <div class="form-group">
            <label for="alias-fungsi" class="col-form-label">Alias :</label>
            <input type="text" class="form-control" id="alias-fungsi" name="alias-fungsi">
          </div>
      </div>
