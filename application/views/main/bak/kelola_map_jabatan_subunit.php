...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var oTable = $('#example').dataTable({
                ...
                "ordering": true,
                "searching": true,
                "ajax":"tes_json/json_map_jab_sub_unit",
                "columns":[
                    {data: "sub_unit"},
                    {data: "jumlah"},
                    {
            ...
            $('#example tbody').on( 'click', '.aksi-edit', function () {
                ...
                console.log(data);
                document.location.href = "app/index/kelola_map_jabatan_subunit_view?reqSubUnit="+data.sub_unit;
            } );
    });
...
<div class="row">
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Mapping Jabatan ke Sub Unit</div>
            </div>
