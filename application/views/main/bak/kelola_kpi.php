    ...
    $(document).ready(function() {
        ...
        var oTable = $('#example').dataTable({
            ...
            $('#example tbody').on( 'click', '.aksi-edit', function () {
                ...
                document.getElementById("kode-kpi").value = data.kode;
                document.getElementById("nama-kpi").value = data.nama;
                document.getElementById("definisi-kpi").value = data.definisi;
                document.getElementById("satuan").value = data.satuan;
                document.getElementById("formula").value = data.formula;
                document.getElementById("frekuensi").value = data.frekuensi;
                document.getElementById("polaritas").value = data.polaritas;
            } );
            ...
            {
                $('#exampleModalCenter').modal('show');
                document.getElementById("kode-kpi").value = "";
                document.getElementById("nama-kpi").value = "";
                document.getElementById("definisi-kpi").value = "";
                document.getElementById("satuan").value = "";
                document.getElementById("formula").value = "";
                document.getElementById("frekuensi").value = "";
                document.getElementById("polaritas").value = "";
            });
...
<div class="row">
            ...
            <ul>
                ...
                <li class="menu"><a data-toggle="collapse" data-target="#collapse1">Master Data</a>
                    <ul id="collapse1" class="collapse in">
                        ...
                        <li class="active"><a href="app/index/kelola_kpi">Katalog KP</a></li>
                    </ul>
                </li>
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Kelola Data KPI</div>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color: rgba(0, 0, 0, 0.1);">
          <div class="form-group">
            <label for="kode-kpi" class="col-form-label">Kode :</label>
            <input type="text" class="form-control" id="kode-kpi" name="kode-kpi">
          </div>
          <div class="form-group">
            <label for="nama-kpi" class="col-form-label">KPI :</label>
            <input type="text" class="form-control" id="nama-kpi" name="nama-kpi">
          </div>
          <div class="form-group">
            <label for="definisi-kpi" class="col-form-label">Definisi :</label>
            <textarea class="form-control" id="definisi-kpi"></textarea>
          </div>
          <div class="form-group">
