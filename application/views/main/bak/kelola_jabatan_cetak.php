...
$worksheet->write(2, 1, "UNIT APA", $text_format_merge);
...
$worksheet->write(3, 1, "BULAN APA", $text_format_merge);
...
$worksheet->write(5, 3, "JABATAN", $text_format_line_bold_no_bottom);
...
header("Content-Type: application/x-msexcel; name=\"cetak_data_jabatan.xls\"");
header("Content-Disposition: inline; filename=\"cetak_data_jabatan.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>