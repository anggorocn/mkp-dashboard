...
<div class="row">
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Skor CLI</div>
            </div>
...
-->
            ...
            <div class="col-md-6">
                <ul class="nav nav-tabs">
                  <li class="active"><a data-toggle="tab" href="#home">Soft Competency</a></li>
                  <li><a data-toggle="tab" href="#menu1">Hard Competency</a></li>
                </ul>
                    ...
                    <div id="home" class="tab-pane fade in active">
                        <div class="area-skillset">
                            <div class="skillbar clearfix " data-percent="20%">
                                <div class="skillbar-title"><span>Managerial Competency</span></div>
                                <div class="skillbar-bar" style="background: #dda009;"></div>
                                <div class="skill-bar-percent">20%</div>
                            </div> <!-- End Skill Bar -->

                            <div class="skillbar clearfix " data-percent="25%">
                                <div class="skillbar-title"><span>Professional Competency</span></div>
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <div class="area-skillset">
                            ...
                            <div class="skillbar clearfix " data-percent="50%">
                                <div class="skillbar-title"><span>Specific Competency</span></div>
                                <div class="skillbar-bar" style="background: #dda009;"></div>
                                <div class="skill-bar-percent">50%</div>
                            </div> <!-- End Skill Bar -->

                            <div class="skillbar clearfix " data-percent="40%">
                                <div class="skillbar-title"><span>Generic Competency</span></div>
                                <div class="skillbar-bar" style="background: #12b24b;"></div>
...
Highcharts.chart('container', {
    ...
    series: [{
        name: 'Soft Competency',
        data: [3, 4, 3, 5, 4],
        color: '#dda009'
    }, {
        name: 'Hard Competency',
        data: [1, 3, 4, 3, 3],
        color: '#12b24b'
    }]
});
