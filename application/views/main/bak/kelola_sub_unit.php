    ...
    $(document).ready(function() {
        ...
        var oTable = $('#example').dataTable({
            ...
            $('#example tbody').on( 'click', '.aksi-edit', function () {
                ...
                document.getElementById("kode-sub-unit").value = data.kode;
                document.getElementById("nama-sub-unit").value = data.nama;
...
<div class="row">
            ...
            <ul>
                ...
                <li class="menu"><a data-toggle="collapse" data-target="#collapse1">Master Data</a>
                    <ul id="collapse1" class="collapse in">
                        ...
                        <li class="active"><a href="app/index/kelola_sub_unit">Sub Unit</a></li>
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Kelola Sub Unit</div>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color: rgba(0, 0, 0, 0.1);">
          <div class="form-group">
            <label for="kode-sub-unit" class="col-form-label">Kode :</label>
            <input type="text" class="form-control" id="kode-sub-unit" name="kode-sub-unit">
          </div>
          <div class="form-group">
            <label for="nama-sub-unit" class="col-form-label">Nama :</label>
            <textarea class="form-control" id="nama-sub-unit"></textarea>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="komoditi" class="col-form-label">Komoditi :</label>
