<div class="row">
    <div class="col-md-2">
        <div class="area-menu-kiri">
            <ul>
                <li class="active"><a>Demografi Karyawan</a></li>
    ...
    <div class="col-md-10">
        <div class="row area-konten">
            <div class="col-md-12">
                <div class="judul-halaman">Dashboard - Demografi Karyawan
                </div>
            </div>
            
            <div class="col-md-12">
                <div class="area-dashboard">
                    <div class="area-demografi">
                        <div class="inner">
                            <div class="img-demografi"><img src="images/img-orang-banyak.png"></div>
                            <div class="circle">
                                <div class="inner">
                                    Total Tenaga Kerja<br>
                                    <span>136.861</span>
                                </div>
                            </div>
