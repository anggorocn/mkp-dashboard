...
(function(n) {
    n(["jquery"], function(n) {
        ...
        function rt(variable) {


            $('#popupRefeshMode').val(variable.refresh);
            if(variable.refresh == "Y")
            {
                function i() {
                    return n('<div class="modal fade" tabindex="-1"><div class=modal-dialog><div class=modal-content> <div class=modal-header><button type=button class="x close" onclick="" data-dismiss=modal><span aria-hidden=true>&times;<\/span><span class=sr-only>Close<\/span><\/button><h4 class=modal-title><\/h4><\/div><\/div><\/div><\/div>').on("hidden.bs.modal", v).on("click", "button.x", function(i) {
        ...
        function v(variable) {
            ...
            try {
                ...
                popupRefeshMode = $('#popupRefeshMode').val();

                if(popupRefeshMode == "Y")
                    top.location.reload();
